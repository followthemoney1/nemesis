...
exports.placeABet = function place(userId, place, matchId, onTeamId) {
    return __awaiter(this, void 0, Promise, function () {
        var currentRef, p, placed, placedObject, newPlace, finalPlaced, resPlaced, t, totals, totalsData, team1, team2, tt, finalTotals, resTotals, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    team1 = totalsData[0];
                    team2 = totalsData[1];
                    tt = (team1.placed_total_sum + team2.placed_total_sum);
